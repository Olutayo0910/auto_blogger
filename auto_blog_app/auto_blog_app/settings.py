"""
Django settings for auto_blog_app project.
...
SECRET_KEY = 'django-insecure-4ltgpl4m1aiv@@841fo@^2*5+0cr=7+=-gtllkgvpk05!6=u1q'
...
ROOT_URLCONF = 'auto_blog_app.urls'
...
WSGI_APPLICATION = 'auto_blog_app.wsgi.application'
